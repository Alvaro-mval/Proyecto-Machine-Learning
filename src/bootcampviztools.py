...
def plot_categorical_numerical_relationship(df, categorical_col, numerical_col, show_values=False, measure='mean'):
    ...
    if grouped_data.shape[0] > 5:
        ...
        for i in range(num_plots):
            ...
            # Crea el gráfico
            plt.figure(figsize=(10, 6))
            ax = sns.barplot(x=data_subset.index, y=data_subset.values, color="#E2BC4AFF")
        ...
        plt.figure(figsize=(10, 6))
        ax = sns.barplot(x=grouped_data.index, y=grouped_data.values,color="#E2BC4AFF")
...
def plot_grouped_boxplots(df, cat_col, num_col):
    ...
    for i in range(0, num_cats, group_size):
        ...
        plt.figure(figsize=(10, 6))
        sns.boxplot(x=cat_col, y=num_col, data=subset_df, palette="YlOrBr")
